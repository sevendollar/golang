...
class GreetServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Hello = channel.unary_unary(
                '/github.com.sevendollar.protobuf.test.GreetService/Hello',
...
def add_GreetServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'github.com.sevendollar.protobuf.test.GreetService', rpc_method_handlers)
...
class GreetService(object):
    ...
    def Hello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/github.com.sevendollar.protobuf.test.GreetService/Hello',
