...
var file_calculator_proto_rawDesc = []byte{
	...
	,
...
var file_calculator_proto_depIdxs = []int32{
	0, // 0: pb.calculator.add:input_type -> pb.request
	0, // 1: pb.calculator.subtract:input_type -> pb.request
	0, // 2: pb.calculator.multiply:input_type -> pb.request
	0, // 3: pb.calculator.divid:input_type -> pb.request
	1, // 4: pb.calculator.add:output_type -> pb.response
	1, // 5: pb.calculator.subtract:output_type -> pb.response
	1, // 6: pb.calculator.multiply:output_type -> pb.response
	1, // 7: pb.calculator.divid:output_type -> pb.response
...
type CalculatorClient interface {
	...
	Divid(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *calculatorClient) Subtract(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/pb.calculator/subtract", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *calculatorClient) Multiply(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/pb.calculator/multiply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *calculatorClient) Divid(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/pb.calculator/divid", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculatorServer interface {
	...
	Divid(context.Context, *Request) (*Response, error)
}
...
func (*UnimplementedCalculatorServer) Divid(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Divid not implemented")
}
...
func _Calculator_Subtract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.calculator/Subtract",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Calculator_Multiply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.calculator/Multiply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Calculator_Divid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalculatorServer).Divid(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.calculator/Divid",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Divid(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Calculator_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "divid",
			Handler:    _Calculator_Divid_Handler,
		},
	},
